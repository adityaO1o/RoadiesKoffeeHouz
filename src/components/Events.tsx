...
const EventCard = ({ date, title, description, image }: { date: string; title: string; description: string; image: string }) => (
...
const Events = () => {
  ...
  return (
    <section id="events" className="roadies-section bg-roadies-dark px-4">
