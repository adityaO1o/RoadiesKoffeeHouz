...
const Menu = () => {
  ...
  const espresso = [
    { name: "Adventure Shot (Medium Strong)", description: "Hot or Iced", price: "135" },
    { name: "Hustle Shot (Super Strong)", description: "Hot or Iced", price: "195" }
  ];
  
  const americano = [
    { name: "Classic Americano", description: "Hot or Iced", price: "195" },
    { name: "Yuzu Citrus Americano", description: "Iced only", price: "215" },
    { name: "Pink Grapefruit Americano", description: "Iced only", price: "215" }
  ];
  
  const cappuccino = [
    { name: "Classic Cappuccino/Latte", description: "Hot or Iced", price: "225/275" },
    { name: "Toffee Nut Cappuccino/Latte", description: "Hot or Iced", price: "225/275" },
    { name: "French Vanilla Cappuccino/Latte", description: "Hot or Iced", price: "225/275" },
    { name: "Irish Cream Cappuccino/Latte", description: "Hot or Iced", price: "225/275" },
    { name: "Roasted Hazelnut Cappuccino/Latte", description: "Hot or Iced", price: "225/275" }
  ];
