...
const Loyalty = () => {
  ...
  return (
    <section className="roadies-section bg-black px-4">
      <div className="container mx-auto">
        <div className="max-w-4xl mx-auto bg-black/70 p-8 rounded-lg border border-roadies-gold/20"
         style={{
          backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.7)), url('/lovable-uploads/loyal.png')",
          ...
          <h2 className="text-3xl md:text-4xl font-display text-center text-roadies-gold mb-4">RIDE MORE. EARN MORE.</h2>
